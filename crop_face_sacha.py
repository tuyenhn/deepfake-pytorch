...
Images_Folder = "train/sacha"
OutFace_Folder = "train/sacha_face/"
...
for f in pictures:
    ...
    for idx, face in enumerate(dets):
        print(
            "face{}; left{}; top {}; right {}; bot {}".format(idx, face.left(), face.top(), face.right(), face.bottom())
        )
